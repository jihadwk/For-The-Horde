...
import com.commonSockt.test.filter.MyIoFilter;
import com.commonSockt.test.filter.MyIoFilter2;
...
public class MinaServer {
	...
	private void init() {
		try {
			...
			acceptor.getFilterChain().addLast("myIoFilter2", new ReferenceCountingFilter(new MyIoFilter2()));
