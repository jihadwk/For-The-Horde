package cn.bw.looters.base.dao;
...
public class DbBaseInfoUpdater {
    ...
    private static final String SQL_UPDATE_BUILDING = "UPDATE bw_building SET " +
            "building_name = ?," +
            "building_type = ?," +
            "swf = ?," +
            "build_time_date = ?," +
            ...
            "is_locked = ? ," +
            "is_hidden = ? ," +
            "trigger_radius = ? WHERE " +
            "building_id = ?";

    public int updateBwBuildingVO(BwBuildingVO vo) throws CacheDaoException {
        return this.jdbcTemplate.update(SQL_UPDATE_BUILDING, new Object[] {
                vo.getBuildingName(),
                vo.getBuildingType(),
                vo.getSwf(),
                vo.getBuildTimeDate(),
                vo.getBuildTimeHour(),
                vo.getBuildTimeMinutes(),
                vo.getBuildResourceType(),
                vo.getWidth(),
                vo.getHeight(),
                vo.getBuildingAnimation(),
                vo.getIsBunker(),
                vo.getProducesResourceType(),
                vo.getUpgradeUnits(),
                vo.getAttackRange(),
                vo.getAttackSpeed(),
                vo.getBuildingCrashW(),
                vo.getBuildingCrashH(),
                vo.getAirTargets(),
                vo.getGroundTargets(),
                vo.getMinAttackRange(),
                vo.getDamageRadius(),
                vo.getPushBack(),
                vo.getIsSell(),
                vo.getIsLocked(),
    ...
    public int updateBwBuildingPropertiesLevelVO(BwBuildingPropertiesLevelVO vo) throws CacheDaoException {
        return jdbcTemplate.update(SQL_UPDATE_BUILDING_PROPERTIES_LEVEL, new Object[] {
                vo.getBuildlevel(),
                vo.getBuildingid(),
                vo.getBuildexportname(),
                vo.getBuildtimedate(),
                vo.getBuildtimehour(),
                vo.getBuildtimeminutes(),
                vo.getBuildcostcount(),
                vo.getTownhalllevel(),
                vo.getMaxstoredgold(),
                vo.getMaxstoredelixir(),
                vo.getHouseingspace(),
                vo.getProduceresourceperhour(),
                vo.getResourcemax(),
                vo.getUnitproduction(),
                vo.getHitpoint(),
                vo.getRegentime(),
                vo.getDamage(),
                vo.getProjectilename(),
                vo.getBwcharacterspropertieslevelid(),
                vo.getCharacterscount(),
                vo.getDestructionxp(),
                vo.getExportnametriggered(),
                vo.getId()
        });
    }
    ...
    public int updateBwCharactersPropertiesLevelVO(BwCharactersPropertiesLevelVO vo) throws CacheDaoException {
        return jdbcTemplate.update(SQL_UPDATE_CHARACTERS_PROPERTIES_LEVEL, new Object[] {
                vo.getCharacterid(),
                vo.getCharacterlevel(),
                vo.getLaboratorylevel(),
                vo.getHitpoints(),
                vo.getTrainingresourcecost(),
                vo.getUpgradetime(),
                vo.getUpgraderesourcecose(),
                vo.getDamage(),
                vo.getDamageradius(),
                vo.getProjectilename(),
                vo.getAttackeffect(),
    ...
    private static final String SQL_UPDATE_CHARACTERS = "UPDATE bw_characters SET " +
            "character_name=?," +
            "swf=?," +
            "housing_space=?," +
            "barrack_level=?," +
    ...
    public int updateBwCharactersVO(BwCharactersVO vo) throws CacheDaoException {
        return jdbcTemplate.update(SQL_UPDATE_CHARACTERS, new Object[] {
                vo.getCharactername(),
                vo.getSwf(),
                vo.getHousingspace(),
                vo.getBarracklevel(),
    ...
    private static final String SQL_UPDATE_INIT_USER = "UPDATE bw_init_user" +
            " SET " +
            " golden_count=?, " +
            " elixir_count=?, " +
            " gem_count=?, " +
    ...
    public void updateInitUser(BwInitUserVO user) {
        jdbcTemplate.update(SQL_UPDATE_INIT_USER,
                user.getGoldenCount(),
                user.getElixirCount(),
                user.getGemCount(),
                user.getExp(),
                user.getOneMinuteCost(),
                user.getOneHourCost(),
                user.getOneDayCost(),
                user.getOneWeekCost(),
                user.getId());
    ...
    private static final String SQL_UPDATE_QUICKEN = "UPDATE bw_quicken " +
            " SET " +
            " quicken_time=?, " +
            " price=?, " +
            " quicken_type=? " +
