package cn.bw.looters.ms.web.ctrl.looters;

import cn.bw.looters.base.dao.DbBaseInfoUpdater;
import cn.bw.looters.ms.web.vo.Res;
import cn.bw.looters.ms.web.vo.ResUtil;
import cn.bw.looters.ms.web.vo.res.JsonStoreRes;
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        for (BwGameChannleVO channel : channelList) {
            try {
                ...
                LOGGER.error("init rmi error: {},{},{}", new Object[]{e, channel.getServiceurl(), channel.getServiceinterface()});
            }
        }
    }
