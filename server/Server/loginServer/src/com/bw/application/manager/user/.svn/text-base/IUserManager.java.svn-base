...
public interface IUserManager {
	 ...
	 */
	public void initPlantUserInforSender(BwPlantUserVO bwPlantUserVO)throws ManagerServerException; 
	public void initPlantUserInfor(BwPlantUserVO bwPlantUserVO) throws ManagerServerException;
	public void initUserInfor(BwUserVO uservo) throws ManagerServerException;
	public void queryUserInforAndGem(BwPlantUserVO bwPlantUserVO) throws ManagerServerException;
